    ...
    <DetailStyled>
      <DataStyled>
        ...
        <PlaceInfo>
          ...
          <div
            style={{ fontSize: "14px", marginTop: "2px", marginBottom: "8px" }}
          >
            {data.places[param.id - 1].address}
          </div>
          <i class="fa-solid fa-star" style={{ color: "#FDDC3C" }}></i>
          <i class="fa-solid fa-star" style={{ color: "#FDDC3C" }}></i>
          <i class="fa-solid fa-star" style={{ color: "#FDDC3C" }}></i>
          <i class="fa-solid fa-star" style={{ color: "#FDDC3C" }}></i>
          (4.0)
      ...
      <Review>
        <TotalReviewStyled>
          ...
          <TotalReviewComment>
            "52"명이{" "}
            <div style={{ color: "#57BE17", marginLeft: "3px" }}>쉬운 코스</div>
            라고 평가했어요!
          </TotalReviewComment>
        </TotalReviewStyled>
        ...
        <EachReview>
          <ReviewEl>
            ...
            <Content>
              <Comment>
                저번주 일요일에 갔다왔는데 나름 잘 하고 왔어요 초보자도 운전하기
                좋은 코스였습니당!^_^{" "}
              </Comment>
              <Level>
                쉬운코스 |{" "}
